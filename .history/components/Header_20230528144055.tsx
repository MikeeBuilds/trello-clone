  ...
  return (
    <header>
        ...
        <div className='flex items-center justify-center px-5 md:py-5'>
            <p className='flex items-center text-sm font-light pr-5 shadow-xl rounded-xl w-fit bg-white
            italic max-w-3xl text-[#0096FF]'>
                <UserCircleIcon className='inline-block h-10 w-10 text-[#0096FF] mr-1'/>                GPT is summarizing your tasks for your day....
            </p>
        </div>
    </header>
  )
