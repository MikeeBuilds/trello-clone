...
function Header() {
  return (
    <header>
        ...
        <div className=''>
            <p>
                <UserCircleIcon className='inline-block h-10 w-10 text-[#import Header from "@/components/Header";
...
export default function Home() {
  return (
    <main className="">
      ...
      {/* Board */}
      <h1>
        <strong>Unleash</strong> your <strong>Productivity</strong> with Our Powerful Tools
      </h1>
    </main>
  );
}
